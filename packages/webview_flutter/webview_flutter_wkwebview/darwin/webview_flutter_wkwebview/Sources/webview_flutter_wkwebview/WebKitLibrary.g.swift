...
protocol PigeonApiDelegateUIViewWKWebView {
  ...
  func setUserInteractionEnabled(pigeonApi: PigeonApiUIViewWKWebView, pigeonInstance: WKWebView, enabled: Bool) throws
  #endif
}
...
withIdentifier: pigeonIdentifierArg)
    ...
    #endif
    #if !os(macOS)
    let setUserInteractionEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.UIViewWKWebView.setUserInteractionEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setUserInteractionEnabledChannel.setMessageHandler { message, reply in
        ...
        let enabledArg = args[1] as! Bool
        do {
          try api.pigeonDelegate.setUserInteractionEnabled(pigeonApi: api, pigeonInstance: pigeonInstanceArg, enabled: enabledArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
...
protocol PigeonApiDelegateNSViewWKWebView {
  ...
  #if !os(iOS)
  /// Enables or disables user interaction for the web view.
  func setUserInteractionEnabled(pigeonApi: PigeonApiNSViewWKWebView, pigeonInstance: WKWebView, enabled: Bool) throws
  #endif
}
...
withIdentifier: pigeonIdentifierArg)
    ...
    #endif
    #if !os(iOS)
    let setUserInteractionEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.NSViewWKWebView.setUserInteractionEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setUserInteractionEnabledChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! WKWebView
