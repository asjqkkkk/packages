...
class UIViewWKWebView extends UIView implements WKWebView {
  ...
  Future<void> setUserInteractionEnabled(bool enabled) async {
    ...
    final BinaryMessenger? pigeonVar_binaryMessenger = pigeon_binaryMessenger;
    const String pigeonVar_channelName =
        'dev.flutter.pigeon.webview_flutter_wkwebview.UIViewWKWebView.setUserInteractionEnabled';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
...
class NSViewWKWebView extends NSObject implements WKWebView {
  ...
  Future<void> setUserInteractionEnabled(bool enabled) async {
    ...
    final BinaryMessenger? pigeonVar_binaryMessenger = pigeon_binaryMessenger;
    const String pigeonVar_channelName =
        'dev.flutter.pigeon.webview_flutter_wkwebview.NSViewWKWebView.setUserInteractionEnabled';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
